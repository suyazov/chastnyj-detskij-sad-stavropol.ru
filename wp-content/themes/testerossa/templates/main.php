                                ...
                                <div class="swiper-slide">
                                    <div class="review__item">
                                        <a data-fancybox="gallery" href="<?php the_sub_field('video'); ?>">
                                            <img src="<?php echo testerossa_get_image_url(get_sub_field('img')); ?>" alt="" width="240" height="300" loading="lazy">
                                            <svg class="icon-play" width="48" height="48" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                                        </a>
                    ...
                    <?php while (have_rows('adv_row')) : the_row(); ?>
                        <div class="col-md-4">
                            <div class="three__item">
                                <img src="<?php echo testerossa_get_image_url(get_sub_field('img')); ?>" alt="" loading="lazy" width="500" height="300">
                                <?php the_sub_field('text'); ?>
                            </div>
                        </div>
                    <?php endwhile; ?>
                    ...
                    <div class="cta__item cta__item-2">
                        <div class="cta__contact-wrap">
                            ...
                            <div class="icon__wrap text-decoration-none">
                                <a href="<?php the_field('wa', 'option'); ?>" class="text-decoration-none wa"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                                ...
                                <a href="<?php the_field('tg', 'option'); ?>" class="text-decoration-none tg"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                                ...
                                <a href="<?php the_field('vk', 'option'); ?>" class="text-decoration-none vk"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
