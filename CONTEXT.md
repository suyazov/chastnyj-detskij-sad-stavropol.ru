...
## Передача из завершённой сессии (22.08.2026)

- На главной странице WordPress были опубликованы два видеоотзыва с обложками. После правки они стояли первыми в карусели; обложки приведены к одному размеру, кадрирование и версия CSS проверены на публичной странице.
- Видеофайлы и порядок отзывов хранятся в WordPress production, а не в этом репозитории. Этот перенос фиксирует последний проверенный результат сессии; текущее состояние сайта требует отдельного read-back перед новой правкой.
