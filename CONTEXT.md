...
- Этот перенос фиксирует последний проверенный результат сессии в WordPress production; текущее состояние сайта требует отдельного read-back перед новой правкой.
